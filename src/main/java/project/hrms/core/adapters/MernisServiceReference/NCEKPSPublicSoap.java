...
public class NCEKPSPublicSoap
{
    ...
    public NCEKPSPublicSoap()
    {
    }

    public NCEKPSPublicSoap(String url)
    {
        this.url=url;
    }

    public NCEKPSPublicSoap (String url,NCEConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        NCERequestResultHandler handler = new NCERequestResultHandler(NCESoapVersion.v1_1);
        return handler;
    }
