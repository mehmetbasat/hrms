...
public class NCEKPSPublicSoap12
{
    ...
    private NCEConnectionProvider connectionProvider=new NCEHttpConnectionProvider();

    public NCEKPSPublicSoap12()
    {
    }

    public NCEKPSPublicSoap12(String url)
    {
        this.url=url;
    }

    public NCEKPSPublicSoap12 (String url,NCEConnectionProvider connectionProvider) {
        this.url=url;
    ...
    protected NCERequestResultHandler createRequestResultHandler()
    {
        NCERequestResultHandler handler = new NCERequestResultHandler(NCESoapVersion.v1_2);
        return handler;
    }
    
    private org.w3c.dom.Document createTCKimlikNoDogrulaRequest(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili,NCERequestResultHandler __handler) throws java.lang.Exception
    {
    ...
    {
        NCERequestResultHandler __handler =createRequestResultHandler();
        ...
        org.w3c.dom.Node __result=NCEHelper.getResult(__handler.getOutputBody(), "TCKimlikNoDogrulaResult",false);
        if(__result!=null)
        {
            return NCEHelper.toBoolFromString(((org.w3c.dom.Element)__result).getTextContent());
        }
        return null;
    }
    protected void sendRequest(String soapAction,org.w3c.dom.Document soapBody, NCERequestResultHandler handler) throws java.lang.Exception
    {
        ...
        String __requestBody=NCEHelper.getStringFromDocument(soapBody);
        if(enableLogging)
        {
            System.out.println("requestDump: "+__requestBody);
        }
        NCEResponseData response=connectionProvider.sendRequest(url,__requestBody, __headers,handler);
        if(enableLogging)
        {
